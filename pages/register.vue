...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      ...
      <h2 class="heading--secondary" v-if="!success">Are you ready to join the elite?</h2>
      <h2 class="heading--secondary" v-else>Your account has been created successfully</h2>
    </div>
  ...
  <div class="container__child signup__form">
    <form @submit.prevent="submitForm">
      <b-alert show :variant="variant" v-if="error !== null"><span v-html="error"></span></b-alert>
      <div class="form-group">
        <label for="email">Name</label>
        <input class="form-control" type="text" v-model="fields.name" id="name" placeholder="John Doe" required />
      </div>
      <div class="form-group">
        <label for="email">Email</label>
        <input class="form-control" type="text" v-model="fields.email" id="email" placeholder="james.bond@spectre.com" required />
      </div>
      <div class="form-group">
        <label for="phone">Phone</label>
        <input class="form-control" type="text" v-model="fields.phone" id="phone" placeholder="081********" required />
      </div>
      <div class="form-group">
        <label for="password">Password</label>
        <input class="form-control" type="password" v-model="fields.password" id="password" placeholder="********" required />
      </div>
      <div class="form-group">
        <label for="passwordRepeat">Repeat Password</label>
        <input class="form-control" type="password" v-model="fields.passwordRepeat" id="passwordRepeat" placeholder="********" required />
      </div>
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            ...
            <input class="btn btn--form" type="submit" value="Register" v-else />
          </li>
          <li>
            <nuxt-link class="signup__link" to="/login">I am already a member</nuxt-link>
          </li>
        </ul>
      </div>
    </form>  
