<template>
  <div
    ...
    :class="[error !== null ? 'increaseFrame' : '']"
  >
    <div class="container__child signup__thumbnail">
      ...
      <div class="thumbnail__content text-center">
        ...
        <h2 class="heading--secondary" v-if="!success">
    ...
    <div class="container__child signup__form">
      <form @submit.prevent="submitForm">
        <b-alert show :variant="variant" v-if="error !== null">{{
          error
        }}</b-alert>
        ...
        <div class="m-t-lg">
          <ul class="list-inline">
            <li>
              ...
              <input class="btn btn--form" type="submit" value="Login" v-else />
            </li>
            <li>
              <nuxt-link class="signup__link" to="/register"
